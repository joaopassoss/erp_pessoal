...
### **1. Filtros Mensais** ✅
- **Problema**: Sintaxe PostgreSQL com SQLite
- **Solução**: Mudança para `func.strftime` (SQLite)
- **Resultado**: Filtros funcionando perfeitamente

### **2. Categorias Inválidas** ✅
- **Problema**: Valores como 'Salário' e 'Moradia' não existiam no enum
- **Solução**: Atualização para valores válidos ('OUTROS', 'MORADIA')
- **Resultado**: Sem mais erros de enum
...
- ✅ **Filtros automáticos**: Dados mudam por mês
